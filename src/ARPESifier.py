...
def arpesify(a, kx, ky, kz, e, zoom_level=2, scale_level=0.01):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-b", "--energy_begin", type=float,
                        help="Energy begin", default=-0.2)
    parser.add_argument("-e", "--energy_end", type=float,
                        help="Energy stop", default=0.05)
    ...
    if args.castep:
        ...
        energies = np.linspace(args.energy_begin,
                               args.energy_end,
                               args.energy_steps)
        (kx, ky, kz, result) = arpesify(en, kx, ky, kz, energies,
